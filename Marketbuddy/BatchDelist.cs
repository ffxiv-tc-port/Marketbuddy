...
namespace Marketbuddy
{
    ...
    internal sealed unsafe class BatchDelist : IRetainerBatchEngine, IDisposable
    {
        ...
        // 🔑 數值兩支相同，所以這組常數兩支共用；但 0x19／0x1C 的**主詞不同**，翻成人話時一定要知道目的地是誰（見 DescribeMoveError）。
        ...
        /// 🔑 這是 <see cref="Start"/> 當下取的**快照**，不是每次用的時候現讀：整輪的開跑訊息、空間量測、呼叫哪支函式與結束語都要講同一個容器。
        /// </summary>
